    ...
    <div className="w-full  min-h-screen flex items-center justify-center">
      ...
      >
        ...
        flex flex-col items-center justify-center gap-2 "
                    >
                      <MdCloudUpload className="text-gray-500 text-3xl hover:first-letter:text-gray-700" />
                      <p className="text-gray-500  hover:first-letter:text-gray-700">
        ...
        <div className="flex items-center w-full">
          <button
            type="button"
            className="ml-0
          md:ml-auto w-full md:w-auto border-none
           outline-none bg-emerald-500 
