...
const Header = () => {
  ...
  return (
      ...
      <div className="hidden  md:flex w-full h-full  items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          <motion.img whileTap={{scale:0.6}}
            ...
            className="w-10 min-w-[40px] h-10 min-h-0-[40px] drop-shadow-xl  cursor-pointer rounded-full"
            alt="userprofile"
            onClick={login}
          />
          {
            ...
            {
              user && user.email ==="wankhedeaman1999@gmail.com" &&(
    ...
    <div className="relative">
          <motion.img whileTap={{scale:0.6}}
            src={user ? user.photoURL :Avatar}
            className="w-10 min-w-[40px] h-10 min-h-0-[40px]
          ...
          />
          {
                ...
                flex flex-col   absolute top-12 right-0 ">
            {
              ...
              transition-all duration-100 ease-in-out
               text-textColor text-base">   NewItem <MdAdd/>   </p>
                </Link>
              )
            }
            <ul 
          className="flex flex-col">
            <li
              className="text-base text-textColor hover:text-headingColor
            duration-100 transition-all ease-in-out cursor-pointer  hover:bg-slate-100  px-4 py-2 "onClick={()=>setIsMenu(false)}
            >
              Home
            </li>
            <li
              className="text-base text-textColor hover:text-headingColor
            duration-100 transition-all ease-in-out cursor-pointe  hover:bg-slate-100 px-4 py-2 "onClick={()=>setIsMenu(false)}
            >
              Menu
            </li>
            <li
              className="text-base text-textColor hover:text-headingColor px-4 py-2 "onClick={()=>setIsMenu(false)}
            >
              About Us
            </li>
            <li
