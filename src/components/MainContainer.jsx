  ...
  return (
    <div className="w-full h-auto flex  flex-col items-center justify-center ">
      ...
      <div className="w-full flex items-center justify-between">
          ...
          before:bottom-0 before:left-0 before:bg-gradient-to-tr from-orange-400 to-orange-600 transition-all
          ...
          <div className="hidden md:flex gap-3 items-center">
            <motion.div  whileTap={{scale:0.75}} className="w-8 h-8 rounded-lg bg-orange-300
             hover:bg-orange-500 cursor-pointer transition-all
              duration-100 ease-out hover:shadow-lg flex items-center 
