    ...
    <section className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full" id="home">
      ...
      >
        ...
        >
          ...
          similique mollitia, suscipit, modi placeat rem enim laborum nostrum
          quibusdam impedit iste repudiandae perferendis amet fugit quam
          ipsaillo vitae vero.
        </p>
        <button
          type="button"
      ...
      <div className="py-2  flex-1  flex items-center relative">
        ...
        />
        <div
          className="w-full h-full absolute top-0 left-0 flex items-center justify-center  lg:px-32
